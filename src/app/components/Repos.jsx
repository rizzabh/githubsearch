  ...
  return (
    <div className="justify-center items-center">
      ...
      <div className="grid grid-cols-3 gap-1 lg:mx-64 max-sm:mx-10 max-md:mx-15 max-md:grid-cols-2">
        ...
        {show && (
          <div
            className="p-2 bg-gray-700 bg-opacity-50 border m-8 border-gray-600 rounded-full text-lg text-center max-sm:text-sm text-gray-400 cursor-pointer"
